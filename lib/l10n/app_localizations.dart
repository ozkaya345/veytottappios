...
abstract class AppLocalizations {
  ...
  /// No description provided for @alreadyMemberQuestion.
  ///
  /// In en, this message translates to:
  /// **'Already a member?'**
  String get alreadyMemberQuestion;
  ...
  /// No description provided for @homeNewStatus.
  ///
  /// In en, this message translates to:
  /// **'Add New Status'**
  String get homeNewStatus;

  /// No description provided for @homeTrackStatus.
  ///
  /// In en, this message translates to:
  /// **'Track Status'**
  String get homeTrackStatus;

  /// No description provided for @personnelTitle.
  ///
  /// In en, this message translates to:
  /// **'Personnel'**
  String get personnelTitle;
}
